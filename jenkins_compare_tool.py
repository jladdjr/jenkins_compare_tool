...
parser.add_argument('--jenkins-username', dest='jenkins_username', help='username')
parser.add_argument('--jenkins-api-token', dest='jenkins_api_token', help='user api token')
